  ...
  return (
    <Card className="w-full max-w-sm mx-auto h-[100%] flex flex-col justify-between">
        ...
        <div className="flex justify-center">
          ...
          <AvatarImage src={user.photoURL || "/default.png"} alt="Profile" className="w-full h-full object-cover object-center"/>
...
export default async function Liked() {
  ...
  console.log(data)
    return (
        ...
        <NavigationBar/>
        <h1 className="text-3xl font-bold mb-8 text-[#4F364B]">Liked</h1>
